...
The prompt for Day 8 of [genuary](https://genuary.art) 2022 is "Single curve only". For this I will plot the gamma distribution, calibrated using the trip length distribution of work trips in the Greater Toronto and Hamilton Region by [Anastasia Soukhov](https://soukhova.github.io/AccessPack/).
...
$$
where the estimated 'shape' is $\alpha$, the estimated 'rate' is $\beta$, and $\Gamma(\alpha)$ is defined as:
...
This shape is quite common for trip length distribution for commuting: very few people commute short or long distances.
